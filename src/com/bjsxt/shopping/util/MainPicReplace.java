...
public class MainPicReplace extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public MainPicReplace() {
		super();
	}
		...
		try {
			...
			while (iter.hasNext()) {
				...
				if (!item.isFormField()) {
					...
					String uploadPath = "";
					if(item.getFieldName().equals("SHOPbanner"))
						uploadPath = context.getRealPath("/") + "pic"+File.separator + "SHOPbanner.jpg";
					...
					if (result) {
						try {
							...
							response.sendRedirect("../admin/homepage/index.jsp");
						} catch (Exception e) {
							out.println(e);
						}
