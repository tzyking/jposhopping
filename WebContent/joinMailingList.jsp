...
<html>
	<head>
        <title>Organic by John Patrick Newsletter</title>
		
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        <meta name="description" content="Organic by John Patrick Newsletter Email Forms">
        <meta name="keywords" content="Organic by John Patrick Newsletter">
  ...
  (function() {
	...
	<body>
		...
		<div class="wrapper rounded6" id="templateContainer">
		    <h1>Organic by John Patrick Newsletter</h1>
...
<div id="subscribeFormWelcome">Please fill the following form to subscribe the Organic by John Patrick Newsletter&nbsp;
</div>
<div class="indicates-required"><span class="asterisk">*</span> indicates required</div>



<form action="http://organicbyjohnpatrick.us6.list-manage.com/subscribe/post" method="POST">
<input type="hidden" name="u" value="647dec7e3692f397ddb080203">
<input type="hidden" name="id" value="075622658f">
...
<label for="MERGE1">Country</label>
<div class="field-group">
...
<input type="submit" class="button" name="submit" value="Subscribe to list">
		...
		<div class="poweredWrapper">
			<span class="poweredBy"><a href="http://www.mailchimp.com/monkey-rewards/?utm_source=freemium_newsletter&utm_medium=email&utm_campaign=monkey_rewards&aid=647dec7e3692f397ddb080203&afl=1"><img src="http://cdn-images.mailchimp.com/monkey_rewards/MC_MonkeyReward_20.png" border="0" alt="Email Marketing Powered by MailChimp" title="MailChimp Email Marketing" width="139" height="54"></a></span>
		</div>
